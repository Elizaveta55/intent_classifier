**Репозиторий для Классификатора Интентов**
...
Для использования репозитория, вы можете следовать следующим шагам:

1. Обучите классификатор, используя файл `intent_classifier.py`, который содержит код для обучения модели на данных из папки `data/`.

2. После успешного обучения, вы можете использовать файл `telegram_bot.py`, чтобы создать бота в Telegram, который будет отвечать на запросы пользователей, определяя их интенты.

3. Для дополнительной информации о методах и результатов экспериментов, вы можете обратиться к Jupyter-ноутбукам в папке `notebooks/`.

Этот репозиторий разработан для облегчения создания классификатора интентов и его интеграции в приложения, включая боты в Telegram. Удачи с вашим проектом!
